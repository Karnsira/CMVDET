...
def generate_patches_cmv(size:int, db_config:DatabaseConfig, WSI_path:str, save_patches_to:str, save_patches_anno_to:str, repeat=10, fit=True):
...
def generate_patches_bg(size:int,db_config:DatabaseConfig, WSI_path:str, save_patches_to:str, number_per_wsi:int, color_thres:int, start_idx:int=0, fold=[1,2], repeat=10):
...
def generate_patches_hard(size:int, WSI_path:str, save_patches_to:str, db_config = DatabaseConfig(class_list=[0,5,6], fold=[1,2], manual=True), start_idx:int=0, repeat=10, fit=True):
