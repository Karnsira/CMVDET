...
def generate_patches_cmv(size:int, db_path:str, WSI_path:str, slide_list:list, save_patches_to:str, save_patches_anno_to:str, fold=[1,2], repeat=10):
...
def generate_patches_bg(size:int, db_path:str, WSI_path:str, slide_list:list, save_patches_to:str, number_per_wsi:int, color_thres:int, start_idx:int=0, fold=[1,2]):
...
def generate_patches_hard(size:int, db_path:str, WSI_path:str, slide_list:list, save_patches_to:str, start_idx:int=0, fold=[1,2], repeat=10, manual=True, class_list=[0,5,6]):
